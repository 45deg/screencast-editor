  ...
  ja: {
    translation: {
      app: {
        ...
        exportStageLoadingRuntime: 'FFmpeg ランタイムを読み込み中',
        exportStageRasterizingOverlay: 'オーバーレイを描画中',
        exportStageWritingInput: '入力動画を書き込み中',
        exportStageWritingOverlay: 'オーバーレイ素材を書き込み中',
        exportStageEncoding: 'エンコード中',
        exportStageFinalizing: '出力を最終処理中',
        exportStageDone: '完了',
