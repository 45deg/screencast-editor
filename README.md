...
The application runs entirely in the browser. Source media is imported locally, previewed in the UI, and exported with `mediabunny` and `WebCodecs`.
...
- `mediabunny` and `WebCodecs` for in-browser export
